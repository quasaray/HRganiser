package com.quasaray.hrganiser.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.quasaray.hrganiser.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.quasaray.hrganiser.repository.UserRepository.USERS_BY_EMAIL_CACHE);
