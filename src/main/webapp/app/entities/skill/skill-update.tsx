  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hRganiserApp.skill.home.createOrEditLabel" data-cy="SkillCreateUpdateHeading">
            <Translate contentKey="hRganiserApp.skill.home.createOrEditLabel">Create or edit a Skill</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hRganiserApp.skill.skillName')}
                id="skill-skillName"
                name="skillName"
                data-cy="skillName"
                type="text"
