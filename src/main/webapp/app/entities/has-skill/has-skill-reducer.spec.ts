...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HASSKILL_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HASSKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HASSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HASSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HASSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HASSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HASSKILL actions', async () => {
      const expectedActions = [
        {
