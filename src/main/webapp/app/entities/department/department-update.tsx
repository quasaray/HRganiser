...
export const DepartmentUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const saveEntity = values => {
    const entity = {
      ...departmentEntity,
      ...values,
      belongsTo: sectors.find(it => it.id.toString() === values.belongsTo.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...departmentEntity,
          belongsTo: departmentEntity?.belongsTo?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hRganiserApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="hRganiserApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hRganiserApp.department.departmentName')}
              ...
              />
              <ValidatedField
                id="department-belongsTo"
                name="belongsTo"
                data-cy="belongsTo"
                label={translate('hRganiserApp.department.belongsTo')}
                type="select"
              >
                <option value="" key="0" />
                {sectors
