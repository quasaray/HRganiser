  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hRganiserApp.sector.home.createOrEditLabel" data-cy="SectorCreateUpdateHeading">
            <Translate contentKey="hRganiserApp.sector.home.createOrEditLabel">Create or edit a Sector</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hRganiserApp.sector.sectorName')}
