...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="knownAs"]`).type('Connecticut blockchains').should('have.value', 'Connecticut blockchains');

      cy.get(`[data-cy="email"]`).type('Hector_Bernhard@yahoo.com').should('have.value', 'Hector_Bernhard@yahoo.com');

      cy.get(`[data-cy="doj"]`).type('2021-10-19').should('have.value', '2021-10-19');

      cy.get(`[data-cy="dod"]`).type('2021-10-20').should('have.value', '2021-10-20');

      cy.get(`[data-cy="dob"]`).type('2021-10-20').should('have.value', '2021-10-20');
      ...
      cy.get(`[data-cy="jobLevel"]`).select('Junior');
